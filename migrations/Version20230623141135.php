 ...
 */
final class Version20230623141135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649B4C494AD FOREIGN KEY (user_situation_id) REFERENCES user_situation (id)');
