 ...
 */
final class Version20230626200229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD biography LONGTEXT DEFAULT NULL, ADD photo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP biography, DROP photo');
    }
}
